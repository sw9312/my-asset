...
# 📱 앱 설정
st.set_page_config(page_title="성우 & 지영 자산관리 V6.5", layout="wide")
...
st.markdown(f"<span style='color: #8b95a1 !important;'>💱 실시간 환율: <b>1$ = {ex_rate:,.2f}원</b></span><br><br>", unsafe_allow_html=True)
...
if data.get("watchlist"):
    ...
    for w in data["watchlist"]:
        c_p, d_chg, d_pct, w_name = get_stock_data(w['ticker'], custom_tuple)
